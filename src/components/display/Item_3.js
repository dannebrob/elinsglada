  ...
  return (
    <div className='bg-lightSand flex flex-col w-full p-8 md:flex-wrap md:flex-row justify-center'>
        ...
        <div className='flex flex-col p-4'>
            ...
            <p>
            Vi är en engagerad personalgrupp som består av rektor, förskollärare, barnskötare och kock. 
            Föräldraföreningen arbetar för att personalen kontinuerligt ska ges möjligheter till utbildning 
            och pedagogisk inspiration. Verksamhetens litenhet och närhet mellan barn, föräldrar och personal 
            skapar en lugn och trygg miljö för barnen och en positiv arbetsplats.
            </p>
